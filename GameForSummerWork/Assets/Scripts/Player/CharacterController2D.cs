...
public class CharacterController2D : MonoBehaviour
{
	...
	public bool firstEnterOnBonusRoomOne = true;
	...
	public float strenthForce = 2.5f;
	public float score = 0;
	public float countShuriken = 6;
	public bool invincible = false; 
	private bool canMove = true;

	//[SerializeField] private AudioSource bonus;
	//[SerializeField] private AudioSource firstaidkit;
	...
	public void GetShuriken(float Shuriken)
	{
		countShuriken += Shuriken;
	}

	public void GetBonus(float _bonus)
	{
		score += _bonus;
	}

	public void GetFirstAidKits(float _kit)
	{
		life += _kit;
		if (life > 10f)
		{
	...
	{
		if (firstEnterOnBonusRoomOne)
		{
			firstEnterOnBonusRoomOne = false;
			return true;
		}
		else return false;
	}

	public void GetDamageFromObject()
	{
		m_Rigidbody2D.AddForce(-transform.forward * strenthForce);
	}
